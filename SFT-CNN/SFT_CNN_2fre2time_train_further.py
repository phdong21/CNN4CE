...
# load model
model = load_model('CNN_UMi_3path_2fre2time_SNR10dB_200ep.hdf5')
...
# checkpoint
filepath='CNN_UMi_3path_2fre2time_SNR10dB_600ep.hdf5'
...
# load model
CNN = load_model('CNN_UMi_3path_2fre2time_SNR10dB_600ep.hdf5')
